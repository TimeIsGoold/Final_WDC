          ...
          <div class="container p-0">
            <div class="row">
              <div class="col-lg-3 order-2 order-lg-0">
                  ...
                  <div class="py-2 px-4 bg-dark text-white mb-3"><strong class="small text-uppercase font-weight-bold"><a class="class-link" href="mantomanInquiry.html">1대1 문의</a></strong></div>
                ...
                <div class="list_none" style="display: block; height: 604px; width: 850px; border: 1px solid lightgray;">
                    <div class="writeNameBox">
                        <div class="writeNameBoxContent" style="margin: auto;">
                            <p style="text-align: left; font-weight: bold; margin-top: 10px; margin-left: 15px;">문의 제목 :  <input type="text" class="titleInput" placeholder="제목을 입력하세요." required style="width: 500px;" value="비밀번호를 바꾸고 싶어요" disabled> </p>
                        </div>
                    </div>
                    <hr>
                    <div class="writeNameBox">
                        <div class="writeNameBoxContent" style="margin: auto;">
                            <p style="text-align: left; font-weight: bold; margin-top: 10px; margin-left: 15px;">작성일 :  
                                <input type="text" class="titleInput"  required style="width: 150px;" value="2021-06-30" disabled> 
                            </p>
                        </div>
                    </div>
                    <hr>
                    <h5 style="margin-left: 15px;">문의내용</h5>
                    <textarea class="wirteContent" style="border-radius: 5px; width: 825px; margin-left: 12px; resize: none; font-size: 20px;" rows="8" name="" placeholder="문의 사항을 적어주세요." required="required" disabled>비밀번호를 까먹어버렸어요</textarea>
                    <h5 style="margin-left: 15px; margin-top: 15px;">관리자 답변</h5>
                    <textarea class="form-control textarea-layer" style="width: 600px; height: 120px; margin-left: 12px; resize: none;">드릴게요! 드릴게요!</textarea>
                </div>
                <br>

           </div>
                          
                          <button style="width: 100px; height: 50px; margin-left: 90%; margin-top: 10px; resize: none;" onclick="location.href='mantomanInquiry.html'">뒤로 가기</button>
            <!-- 리스트 없을때 -->
          </div>
        </section>
      </div>
