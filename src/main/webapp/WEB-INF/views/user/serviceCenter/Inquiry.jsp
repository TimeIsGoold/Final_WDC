            ...
            <div class="row">
              ...
              <div class="col-lg-9 order-1 order-lg-2 mb-5 mb-lg-0" style="text-align: center;">
                <div class="container p-0">
                  <div class="row">
                    <table class="table table-hover" style="width: 850px;">
                      ...
                      <tbody>
                        <tr class="tr-hover">
                          <th>2</th>
                          <td><a href="mantomanInquiry_detail.html">비밀번호를 바꾸고 싶어요</a></td>
                          <td>21.05.13</td>
                          <td>처리중</td>
                        </tr>   
                        <tr class="tr-hover">
                          <th>1</th>
                          <td><a href="mantomanInquiry_detail.html">환불 요금이 안들어옵니다</a></td>
                          <td>21.04.18</th>
                          <td>처리완료</th>
                        </tr>   
                      </tbody>
                  ...
                  <button type="submit" class="btn btn-dark" style="float: right; width: 120px;" onclick="location.href='mantomanInquery_write.html'">새 문의</button>
                  <!-- PAGINATION-->
