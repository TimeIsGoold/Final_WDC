          ...
          <div class="container p-0">
            <div class="row">
              <div class="col-lg-3 order-2 order-lg-0">
                ...
                <div class="py-2 px-4 bg-dark text-white mb-3"><strong class="small text-uppercase font-weight-bold"><a class="class-link" href="#">나의 신고</a></strong></div>
              </div>
              <!-- BILLING ADDRESS-->
                ...
                <div class="container p-0">
                  <div class="row">
                    ...
                    <tbody>
                        ...
                        <th>2</th>
                        <td>
                          <a href="reportList_detail.html">불량 강사 신고</a></td>
                        <td>21.05.13</th>
                        <td>처리중</th>
                      </tr>   
                      <tr>
