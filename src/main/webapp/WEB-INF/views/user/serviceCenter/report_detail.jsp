            ...
            <div class="row">
              <div class="col-lg-3 order-2 order-lg-0">
                ...
                <div class="list_none" style="display: block; height: 604px; width: 850px; border: 1px solid lightgray;">
                    <div class="writeNameBox">
                        <div class="writeNameBoxContent" style="margin: auto;">
                            <p style="text-align: left; font-weight: bold; margin-top: 10px; margin-left: 15px;">신고 제목 :  
                                <input type="text" class="titleInput"  required style="width: 500px;" value="불량강사 신고" disabled>
                            </p>
                        </div>
                    </div>
                    <hr>
                    ...
                    <div class="writeNameBox">
                        <div class="writeNameBoxContent" style="margin: auto;">
                            <p style="text-align: left; font-weight: bold; margin-top: 10px; margin-left: 25px;">처리상태 :  
                                <input type="text" class="titleInput"  required style="width: 150px;" value="대기중" disabled> 
                            </p>
                        </div>
                    </div>
                    <hr>
                    <h5 style="margin-left: 15px;">문의내용</h5>
                    <textarea class="wirteContent" style="border-radius: 5px; width: 825px; margin-left: 12px; resize: none; font-size: 20px;" rows="8" required="required" disabled>수업 진도가 너무 빨라요</textarea>
                ...
                <br>
                          ...
                          <button style="width: 100px; height: 50px; margin-left: 90%; margin-top: 10px; resize: none;" onclick="location.href='reortList.html'">뒤로 가기</button>
            <!-- 리스트 없을때 -->
          </div>
        </section>
      </div>
