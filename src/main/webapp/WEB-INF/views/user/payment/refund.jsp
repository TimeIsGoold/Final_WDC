        ...
        <section class="py-5">
          <div class="row">
            <div class="col-lg-8 mb-4 mb-lg-0">
              ...
              <li>&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;이름 :&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
              <input type="text" placeholder="신청자 이름을 입력해 주세요" style="margin-bottom: 10px; margin-top: 10px; width: 250px;" id="name" class="refunderInfo" value="한 불" disabled></li>
              <br>
              <li>휴대폰 번호 :&nbsp;
              <input type="text" placeholder="휴대폰 번호를 입력해 주세요" style="width: 250px;" id="phone" class="refunderInfo" value="010-1234-5678" disabled> </li>
              <br>
              <li>입금 은행 :&nbsp;
                <input type="text" placeholder="계좌 번호를 입력해 주세요" style="width: 250px;" id="phone" class="refunderInfo" > </li>
                <br>
              <li>환불 계좌 :&nbsp;
                ...
                <br><br>
                <li>예금주 :&nbsp;
                  <input type="text" placeholder="" style="width: 250px;" id="phone" class="refunderInfo" value="한 불" disabled> </li>
                  <br>
              <br>
              <!-- 주문번호-->
              <div class="bg-light px-4 py-3">
                <div class="row align-items-center text-center">
                  <div class="col-md-6 mb-3 mb-md-0 text-md-left"><i class="fas mr-2 "> 주문번호 </i>
                </div>
                <div style="margin-left: 20px;"> <input type="text" disabled style="border: 1px solid black; border-radius: 5px; width: 150px;" value="161412456" class="refunderInfo"></div>
                </div>
              </div>
              <br>
              ...
              <div class="bg-light px-4 py-3">
                <div class="row align-items-center text-center">
                  <div class="col-md-6 mb-3 mb-md-0 text-md-left"><i class="fas mr-2 "> 강의 진행 상태 </i>
                </div>
              ...
              <div class="bg-light px-4 py-3">
                <div class="row align-items-center text-center">
                  <div class="col-md-6 mb-3 mb-md-0 text-md-left"><i class="fas mr-2 "> 취소 사유 선택 </i>
                </div>
              ...
              <textarea style="resize: none; width: 350px; height: 100px; margin-top: 5px; border-radius: 5px;" placeholder="기타 사유를 작성해 주세요"></textarea>
    <!-- 
              <input type="radio" value="refund1" name="refundReason" class="refundReasonInput"> 기타 <input type="text" placeholder="기타 사항을 적어주세요"> -->
              <br>
              <br>
              <!-- 약관 동의 -->
              <div class="bg-light px-4 py-3">
                <div class="row align-items-center text-center">
                  <div class="col-md-6 mb-3 mb-md-0 text-md-left"><i class="fas mr-2">환불 약관 </i></div>
                </div>
            </div>
                    ...
                    <ul class="list-unstyled mb-0">
                      ...
                      <li>
                          ...
                          <div class="form-group mb-0">
                            <button class="btn btn-dark btn-sm btn-block" onclick="checkContent();" data-toggle="modal"> <i class="fas fa-caret-right mr-2"></i>환불 신청하기</button>
                          </div>
