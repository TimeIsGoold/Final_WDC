...
<html>
  <head>
    ...
    <link rel="stylesheet" type="text/css" href="js/jsTest/jquery.datetimepicker.css"/>
    <script src="js/jsTest/jquery.js"></script>
    <script src="js/jsTest/jquery.datetimepicker.full.min.js"></script>
    <script>
      function onDisplay() {
          $('#noneDiv').show();
      }
