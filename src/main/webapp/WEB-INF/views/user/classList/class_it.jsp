          ...
          <div class="container p-0">
            <div class="row">
              ...
              <div class="col-lg-3 order-2 order-lg-1">
                ...
                <div class="py-2 px-4 bg-dark text-white mb-3"><strong class="small text-uppercase font-weight-bold"><a class="class-link" href="class_it.html">컴퓨터 · IT</a></strong></div>
                ...
                <div class="row">
                  ...
                  <div class="col-lg-4 col-sm-6">
                    <div class="product text-center">
                      ...
                      <h6> <a class="reset-anchor" href="detail.html">컴퓨터클래스</a></h6>
