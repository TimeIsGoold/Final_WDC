                                            ...
                                            <div class="col-lg-8">
                                              ...
                                              <div class="media mb-3"><img class="rounded-circle" src="img/user.png" alt="" width="50">
                                                <div class="media-body ml-3">
                                                  ...
                                                  <br>
                                                  <p class="text-small mb-0 text-muted">답글달기</p>
                                                </div>
                                              </div>
                                              <!-- 문의2 -->
                                              <div class="media mb-3"><img class="rounded-circle" src="img/user.png" alt="" width="50">
                                                <div class="media-body ml-3">
                                                  ...
                                                  <br>
                                                  <button type="submit" onclick="onDisplay()" class="text-small mb-0 text-muted">답글달기</button><br>
                                                  <div id="noneDiv" style="width:900px; height: 110px; background-color: #f8f9fa ; display: none;">
                                                    <div class="media mb-3"><img class="rounded-circle" src="img/user.png" alt="" width="50">
                                                      <div class="media-body ml-3">
                                                        <h6 class="mb-0 text-uppercase">최박</h6>
                                                        <p class="small text-muted mb-0 text-uppercase">2021-06-11</p>
