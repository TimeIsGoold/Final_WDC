...
<body>
  <div class="header" id="top">
    <c:choose>
        ...
        <c:otherwise>
        <nav class="navbar navbar-expand-lg navbar-light py-3 px-lg-0"><a class="navbar-brand" href="#"><span class="font-weight-bold text-uppercase text-dark"><img src="${pageContext.servletContext.contextPath }/resources/teacher/img/favicon2.png" width="35px" height="35px">우리동네 클래스</span></a>
          <button class="navbar-toggler navbar-toggler-right" type="button" data-toggle="collapse" data-target="#navbarSupportedContent" aria-controls="navbarSupportedContent" aria-expanded="false" aria-label="Toggle navigation"><span class="navbar-toggler-icon"></span></button>
          <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav mr-auto">
              <li class="nav-item">강사페이지</li>
