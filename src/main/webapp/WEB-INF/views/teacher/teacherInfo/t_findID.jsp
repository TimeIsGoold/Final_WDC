            ...
            <div class="card-body"><br>
              <h4 class="mb-5">아이디찾기</h4>
                ...
                <div class="col-sm-12" align="center" style="padding: 0px 0px 0px 0px;">
                  <button style="width:100%; height: 38px;" type="button" id="authentication" value="0">휴대폰 번호로 인증번호 전송</button>
                </div>
                <br>
                ...
                <div class="form-group row">
                  <div class="col-sm-12" align="center" style="padding: 0px 0px 0px 0px;">
                    <button style="width:100%; height: 38px;" type="button" class="btn btn-primary" data-toggle="modal" data-target="#idFind" id="findIdModal">아이디찾기</button>
                  </div>
                </div>
            </div>
          </div>
